function DCM = rseeg_conductance_DCM(directory, mri_dir, subject)
...
output_folder = [directory '\DCM_file_cmm_NMDA'];
...
DCM.name        = ['DCM_cmmNMDA_',sprintf('%02d',subject)];
...
dcm_filename = fullfile(output_folder,...
    ['DCM_cmmNMDA_',sprintf('%02d',subject),'.mat']);
